...
const Index = () => {
  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-100">
            ...
            <Form className="mt-5 space-y-5">
              <div>
                ...
                <Field
                  ...
                  className={`mt-2 w-full rounded-lg py-3 px-4 border transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 ${
              ...
              <div className="pt-2">
                <Button
                  ...
                  className="w-full rounded-lg bg-purple-500 py-3 px-5 text-lg font-medium text-white hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                >
                  {isLoggingIn ? (
...
export default withAuth(Index, {
  ...
  redirectIfNotAuthenticated: "/secure-login",
